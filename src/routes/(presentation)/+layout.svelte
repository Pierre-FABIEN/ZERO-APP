<script>
	...
	import SidebarPresentation from '$lib/components/navigation/SidebarPresentation.svelte';
	import SmoothScrollBar from '$lib/components/smoothScrollBar/SmoothScrollBar.svelte';
	import { initializeLayoutState } from '../layout.svelte';
